...
def run_all_plots():
	uri = pd.read_csv("uri_offense.csv")

	uri_clean = clean_data(uri)

	playcall_by_distance(uri_clean, 3, "URI offense")
	playcall_by_distance(uri_clean, 4, "URI offense")

	playcall_success_by_distance(uri_clean, 3, "URI offense")
	playcall_success_by_distance(uri_clean, 4, "URI offense")

	playcall_success_by_distance_category(uri_clean, 4, "URI offense")
	playcall_success_by_distance_category(uri_clean, 4, "URI offense")
